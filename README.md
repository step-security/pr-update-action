...
![Update Pull Request](https://github.com/step-security/pr-update-action/workflows/Update%20Pull%20Request/badge.svg)
[![Release](https://img.shields.io/github/release/step-security/pr-update-action.svg)](https://github.com/step-security/pr-update-action/releases/latest)
...
jobs:
  update_pr:
    ...
    steps:
    - uses: step-security/pr-update-action@v2
      with:
